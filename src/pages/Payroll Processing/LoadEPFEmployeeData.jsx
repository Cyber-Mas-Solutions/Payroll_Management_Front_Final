...
const LoadEPFEmployeeData = () => {
  const navigate = useNavigate();

  const employees = [
    { id: "0001", name: "Rashmi Samadara", dept: "HR", epf: "EPF001", status: "Processed" },
    { id: "0005", name: "Janith Perera", dept: "Finance", epf: "EPF005", status: "Processed" },
    { id: "0006", name: "Malithi Gamage", dept: "HR", epf: "EPF006", status: "Pending" },
    { id: "0008", name: "Raveen Silva", dept: "HR", epf: "EPF008", status: "Processed" },
  ];
        ...
        <div>
          <div className="card" style={{ padding: 24, borderRadius: 20 }}>
            <p style={{ color: "var(--muted)", marginBottom: 24, fontSize: 14 }}>
              Follow the steps below to process EPF contributions for employees.
            </p>
            ...
            >
              ...
              <span style={{ color: "var(--muted)" }}>Review EPF Calculation</span>
              <span style={{ color: "var(--muted)" }}>Confirm Transfer</span>
            </div>
            ...
            >
              <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                ...
                <strong style={{ fontSize: 15 }}>EPF Data Loaded Successfully</strong>
              </div>
              <p style={{ fontSize: 13, marginTop: 4, marginLeft: 30, opacity: 0.8 }}>
                EPF records loaded for April 2025
              </p>
            </div>

            {/* TABLE TITLE */}
            <h3 style={{ marginBottom: 16, fontWeight: 700, fontSize: 18 }}>
              Employee EPF Records
            </h3>
              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <th style={{ background: "#F9FAFB" }}>EPF NO</th>
                ...
                <tbody>
                  {employees.map((emp) => (
                    <tr key={emp.id}>
                      ...
                      <td style={{ verticalAlign: "middle" }}>{emp.epf}</td>
            ...
            <p style={{ fontSize: 13, color: "#6B7280", margin: "16px 0" }}>
              Showing <strong>4</strong> of 127 EPF records
            </p>
          ...
          <div className="card" style={{ padding: 32, borderRadius: 32, border: "1px solid #E5E7EB" }}>
            ...
            >
              ...
              <div>
                ...
                <h1 style={{ fontSize: 20, fontWeight: 600, margin: 0, color: "#16A34A" }}>
                  Rs. 4,088,000
                </h1>
              </div>
            </div>
...
export default LoadEPFEmployeeData;