// src/pages/ReviewSalaryCalculations.jsx
...
const ReviewSalaryCalculations = () => {
        ...
        <div>
          <div className="card" style={{ padding: 24 }}>
            ...
            >
              ...
              <button className="btn btn-primary" onClick={() => navigate("/finalize-payroll")}
              >Next › </button>
            </div>
          </div>
        </div>
...
export default ReviewSalaryCalculations;
